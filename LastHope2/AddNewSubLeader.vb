...
Public Class AddNewSubLeader
    ...
    Private Sub AddNewSubLeader_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        db = New Database()
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If partnerid <> String.Empty Then
            ...
            cmd.Parameters.AddWithValue("@leaderid", PublicModule.mainleaderid)
